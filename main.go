...
const baseDomain = "https://www.theguardian.com/"

func userAgents() []string {
	return []string{"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36",
...
func randomUserAgent() string {
	...
	userAgentsSlice := userAgents()
	return userAgentsSlice[randNum]
}
...
func resolveRelativeLinks(href, baseURL string) (bool, string) {
